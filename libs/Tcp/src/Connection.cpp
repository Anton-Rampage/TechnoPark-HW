...
std::string Connection::get_src_ip() const { return _src_ip; }

uint16_t Connection::get_src_port() const { return _src_port; }

std::string Connection::get_dst_ip() const { return _dst_ip; }

uint16_t Connection::get_dst_port() const { return _dst_port; }
